      ...
      'offer':
        {
          ...
          'type': OFFER_TYPES[generateIntegralNum(0, OFFER_TYPES.length - 1)],
          'rooms': generateIntegralNum(OFFER_ROOMS_MIN, OFFER_ROOMS_MAX),
          'guests': generateIntegralNum(OFFER_GUESTS_MIN, OFFER_GUESTS_MAX),
          'checkin': OFFER_CHECKINS[generateIntegralNum(0, OFFER_CHECKINS.length - 1)],
          'checkout': OFFER_CHECKOUTS[generateIntegralNum(0, OFFER_CHECKOUTS.length - 1)],
